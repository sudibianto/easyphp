...
$module_info = array(
	...
	"module_application_name" 		=> "Adminer",
	"module_application_version" 	=> $module_version,
	"en"	=>	array(
		"Application"	=>	array(
				"Installation date"	=>	"2018-07-25 10:21:01",
				"Website"	=>	"<a href='https://www.adminer.org' target='_blank'>www.adminer.org</a>"
		),
		...
		"How to uninstall this module ?"	=>	array(
				"If you want to uninstall this module, you just have to<br />delete the folder"	=>	"<br />[modules folder]\\adminer431x180725102101",
		),	
	),
	"fr"	=>	array(
		"Application"	=>	array(
				"Date d'installation"	=>	"2018-07-25 10:21:01",
				"Site web"	=>	"<a href='https://www.adminer.org' target='_blank'>www.adminer.org</a>"
		),
		"Comment d&eacute;sinstaller ce module ?"	=>	array(
				"Si vous voulez d&eacute;sinstaller ce module, il suffit de supprimer le r&eacute;pertoire"	=>	"<br />[modules folder]\\adminer431x180725102101",
		),
	),	
);
...
if ($eds_httpserver_running == 1 AND $eds_dbserver_running == 1) {
	?>
	<div class="row panel panel-default" style="margin:0px 0px 5px 0px;padding:5px;background-color:#ecf0f1;border:none;;">
		...
		<div class="col-sm-10" style="padding:5px 0px 0px 5px;">
			<img src="images/modules_icon_adminer.png" />
		...
		<div class="col-sm-2 text-right" style="padding:0px 0px 0px 0px;">
			<a href="http://127.0.0.1:<?php echo $conf_httpserver['httpserver_port'] ?>/eds-modules/<?php echo basename(__DIR__) ?>/index.php?username=root" class="btn btn-primary btn-sm" target="_blank">open</a>
		</div>
